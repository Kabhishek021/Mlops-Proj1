...
class ModelEvaluation:
    ...
    def evaluate_model(self):
        ...
        try:
            ...
            logging.info(f"F1_score for this mdoel: {trained_model_f1_score}")

            best_model_f1_score = None
            best_model = self.get_best_model()
            if best_model is not None:

                logging.info(f"Compting F1_score for production model..")
    ...
    def initiate_model_evaluation(self):
        ...
        try:
            print("----------------------------------------------------------------------------------")
            logging.info("Initized Model Evaluation Component ")
