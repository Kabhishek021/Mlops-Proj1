...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        ...
        try:
            #Initialize trasnfomers

            numeric_transformer = StandardScaler()
            min_max_scaler = MinMaxScaler()

            logging.info('Transformers initialized: Standardscaler-MinMacscaler')

            #load the scjema configuration 

            num_features = self._schema_config['num_features']
            mm_columns = self._schema_config['mm_columns']
            logging.info("col loaded from schema")

            #ctreating preprocessor pipeline 
            ...
            #warpping everything in s a single pipeline 
